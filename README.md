...
Below are the numbers we are onserving for SHA-256 and SHA-512. The numbers are not that impressive. Even OpenSSL's numbers are relatively bad. We expect Power8's SHA-256 to be somewhere between 2 to 8 cpb but it is only a guess.
