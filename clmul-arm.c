...
void clmul_arm(uint8_t r[16], const uint8_t a[16], const uint8_t b[16])
{
    ...
    /* polynomial multiply */
    z = vdupq_n_u8(0);
    r0 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(a8),0),
                                vgetq_lane_u64(vreinterpretq_u64_u8(b8),0)));
    r1 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(a8),1),
                                vgetq_lane_u64(vreinterpretq_u64_u8(b8),1)));
    t0 = vextq_u8(b8, b8, 8);
    t1 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(a8),0),
                                vgetq_lane_u64(vreinterpretq_u64_u8(t0),0)));
    t0 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(a8),1),
                                vgetq_lane_u64(vreinterpretq_u64_u8(t0),1)));
    t0 = veorq_u8(t0, t1);
    t1 = vextq_u8(z, t0, 8);
    r0 = veorq_u8(r0, t1);
    t1 = vextq_u8(t0, z, 8);
    ...
    t0 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(r1),1),
                                vgetq_lane_u64(vreinterpretq_u64_u8(p),1)));
    t1 = vextq_u8(t0, z, 8);
    r1 = veorq_u8(r1, t1);
    t1 = vextq_u8(z, t0, 8);
    r0 = veorq_u8(r0, t1);
    t0 = (uint8x16_t)(vmull_p64(vgetq_lane_u64(vreinterpretq_u64_u8(r1),0),
                                vgetq_lane_u64(vreinterpretq_u64_u8(p),0)));
    c8 = veorq_u8(r0, t0);
